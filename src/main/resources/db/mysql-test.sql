...
INSERT INTO artist(ID, CREATIONTIME, UPDATETIME, VERSION, FIRSTNAME, LASTNAME, ARTISTICNAME, VATNUMBER, EMAIL, PASSWORD, PHONE, ADDRESS_ID) VALUES
  (1, TIMESTAMP '2017-10-10 10:18:53.819', TIMESTAMP '2017-10-10 10:22:58.578', 2, 'Jorge', 'Santos', 'JS', 100, 'hwkvfds@jskhd.com', 'hjfs', '2789364', 5),
  (2, TIMESTAMP '2017-10-10 10:23:02.194', TIMESTAMP '2017-10-10 10:23:19.801', 1, 'Diogo', 'Sousa', 'ds', 109, 'hkvfds@jskhd.com', 'hjfrfgs', '278364', 6),
  (3, TIMESTAMP '2017-10-10 14:30:37.769', TIMESTAMP '2017-10-10 14:30:43.042', 1, 'Tiago', 'lemos', 'tl', 108, 'hwkfds@jskhd.com', 'hjevfs', '279364',  7),
  (4, TIMESTAMP '2017-10-10 14:30:38.426', TIMESTAMP '2017-10-10 14:30:46.471', 1, 'Paulo', 'alberto', 'pa', 300, 'hwkvds@jskhd.com', 'hjfwfs', '289364', 8),

DELETE FROM shows;
INSERT INTO shows(ID, CREATIONTIME, UPDATETIME, VERSION, NAME, DATA, DURATIONTIME, CAPACATYLIMIT, HIGLIGHT) VALUES
...
DELETE FROM address;
INSERT INTO address(ID, CREATIONTIME, UPDATETIME, VERSION, ADDRESS, ZIP-CODE, CITY, COUNTRY) VALUES
...
DELETE FROM product;
INSERT INTO product(ID, CREATIONTIME, UPDATETIME, VERSION, NAME , AVALILABLEQUANTITY, AVAILABLEDATE, PRODUCTTYPE, ISACTIVE) VALUES
  (1, TIMESTAMP '2017-10-10 08:45:56.468', TIMESTAMP '2017-10-10 08:45:56.468', 1, 'jacket', '732652', '2020-04-17', 'clothes', 1),
  (2, TIMESTAMP '2017-10-10 08:45:56.468', TIMESTAMP '2017-10-10 08:45:56.468', 1, 'beer', '546472475', '2020-04-17', 'drinks', 0);
  (3, TIMESTAMP '2017-10-10 08:45:56.468', TIMESTAMP '2017-10-10 08:45:56.468', 1, 't-shirt', '7326435352', '2020-04-17', 'clothes', 1),
